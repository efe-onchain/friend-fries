...
export type Participant_orderBy = "id" | "participated" | "totalRewards";
...
> = ResolversObject<{
  ...
  participants?: Resolver<
    Array<ResolversTypes["BountyParticipant"]>,
    ParentType,
    ContextType,
    RequireFields<BountyparticipantsArgs, "skip" | "first">
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type BountyParticipantResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["BountyParticipant"] = ResolversParentTypes["BountyParticipant"]
> = ResolversObject<{
  id?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>;
...
> = ResolversObject<{
  ...
  participated?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<ParticipantparticipatedArgs, "skip" | "first">
  >;
...
> = ResolversObject<{
  bounty?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerybountyArgs, "id" | "subgraphError">
  >;
  bounties?: Resolver<
    Array<ResolversTypes["Bounty"]>,
    ParentType,
    ContextType,
    RequireFields<QuerybountiesArgs, "skip" | "first" | "subgraphError">
  >;
  ...
  participants?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryparticipantsArgs, "skip" | "first" | "subgraphError">
  >;
  bountyParticipant?: Resolver<
    Maybe<ResolversTypes["BountyParticipant"]>,
    ParentType,
    ContextType,
    RequireFields<QuerybountyParticipantArgs, "id" | "subgraphError">
  >;
  bountyParticipants?: Resolver<
    Array<ResolversTypes["BountyParticipant"]>,
    ParentType,
    ContextType,
    RequireFields<QuerybountyParticipantsArgs, "skip" | "first" | "subgraphError">
  >;
...
> = ResolversObject<{
  bounty?: SubscriptionResolver<
    Maybe<ResolversTypes["Bounty"]>,
    "bounty",
    ParentType,
    ContextType,
    RequireFields<SubscriptionbountyArgs, "id" | "subgraphError">
  >;
  bounties?: SubscriptionResolver<
    Array<ResolversTypes["Bounty"]>,
    "bounties",
    ParentType,
    ContextType,
    RequireFields<SubscriptionbountiesArgs, "skip" | "first" | "subgraphError">
  >;
  ...
  participants?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptionparticipantsArgs, "skip" | "first" | "subgraphError">
  >;
  bountyParticipant?: SubscriptionResolver<
    Maybe<ResolversTypes["BountyParticipant"]>,
    "bountyParticipant",
    ParentType,
    ContextType,
    RequireFields<SubscriptionbountyParticipantArgs, "id" | "subgraphError">
  >;
  bountyParticipants?: SubscriptionResolver<
    Array<ResolversTypes["BountyParticipant"]>,
    "bountyParticipants",
    ParentType,
    ContextType,
    RequireFields<SubscriptionbountyParticipantsArgs, "skip" | "first" | "subgraphError">
  >;
...
export async function getMeshOptions(): Promise<GetMeshOptions> {
  ...
  const friendfriesHandler = new GraphqlHandler({
    ...
    config: {
      endpoint:
        "https://gateway-arbitrum.network.thegraph.com/api/6dbf780f09e4aab821388ccf2892cc78/subgraphs/id/AQL2hBo9CeiaCNP2Ks3iJHVo1iXiBgAVJBXJwnta9Xny",
    },
    baseDir,
    cache,
    pubsub,
...
export type LatestBountiesQuery = {
  bounties: Array<
    Pick<
      Bounty,
      | "id"
...
export type ProfileDetailsQuery = {
  participant?: Maybe<
    Pick<Participant, "id" | "totalRewards"> & { participated: Array<Pick<BountyParticipant, "id">> }
  >;
};
...
export type ProfileBountiesQuery = {
  bounties: Array<
    Pick<
      Bounty,
      | "id"
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    LatestBounties(variables?: LatestBountiesQueryVariables, options?: C): Promise<LatestBountiesQuery> {
      return requester<LatestBountiesQuery, LatestBountiesQueryVariables>(
        LatestBountiesDocument,
        variables,
        options
      ) as Promise<LatestBountiesQuery>;
    },
    Leaderboard(variables?: LeaderboardQueryVariables, options?: C): Promise<LeaderboardQuery> {
      return requester<LeaderboardQuery, LeaderboardQueryVariables>(
        LeaderboardDocument,
        variables,
        options
      ) as Promise<LeaderboardQuery>;
    },
    ProfileDetails(variables: ProfileDetailsQueryVariables, options?: C): Promise<ProfileDetailsQuery> {
      return requester<ProfileDetailsQuery, ProfileDetailsQueryVariables>(
        ProfileDetailsDocument,
        variables,
        options
      ) as Promise<ProfileDetailsQuery>;
    },
    ProfileBounties(variables: ProfileBountiesQueryVariables, options?: C): Promise<ProfileBountiesQuery> {
      return requester<ProfileBountiesQuery, ProfileBountiesQueryVariables>(
        ProfileBountiesDocument,
        variables,
        options
      ) as Promise<ProfileBountiesQuery>;
    },
  };
}
